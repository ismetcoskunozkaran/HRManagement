...
{
    public partial class NTierNewDB1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitorComments", x => x.CommentsID);
                    table.ForeignKey(
                        name: "FK_VisitorComments_Admins_AdminID",
                        column: x => x.AdminID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitorComments_AdminID",
                table: "VisitorComments",
                column: "AdminID");
        }
